...
import Evaluacion from './components/estrellas/Estrellas';
      ...
      {!currentScreen && (
        <View style={styles.bienvenida}>
          ...
          <TouchableOpacity onPress={() => navigateToProfile('personal')}>
            <Text style={styles.botonNavegacion}>Ver Alejandro</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigateToProfile('admirado')}>
            <Text style={styles.botonNavegacion}>Ver Canserbero</Text>
          </TouchableOpacity>
        </View>
      )}
    </SafeAreaView>
